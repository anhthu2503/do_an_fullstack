                ...
                <div class="tabs tabs-style-line pt-md-5">
                    <nav class="container">
                        <ul id="clothing-nav" class="nav nav-tabs tabs-style-line" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#trend" role="tab" id="men-tab" data-toggle="tab" aria-controls="men">Xu hướng
                        </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="trend" aria-labelledby="men-tab">
                            <div id="owl-demo1" class="owl-carousel text-center">
                                <div class="item">
                                    ...
                                    <div class="card product-men p-3">
                                        <div class="men-thumb-item">
                                            <img src="images/fs4.jpg" alt="img" class="card-img-top" />
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                ...
                                <div class="item">
                                    ...
                                    <div class="card product-men p-3 out_w3">
                                        ...
                                        <div class="card-body  py-3 px-2">
                                            <h5 class="card-title text-capitalize">Đọc vị bất kì ai</h5>
                                            <div class="card-text d-flex justify-content-between">
                            ...
                            <div id="owl-demo2" class="owl-carousel text-center">
                                <div class="item">
                                    ...
                                    <div class="card product-men p-3">
                                        ...
                                        <div class="card-body  py-3 px-2">
                                            <h5 class="card-title text-capitalize">Ai rồi cũng qua ID 4.0</h5>
                                            <div class="card-text d-flex justify-content-between">
                                                <p class="text-dark font-weight-bold">$20.00</p>
                                ...
                                <div class="item">
                                    ...
                                    <div class="card product-men p-3">
                                        ...
                                        <div class="card-body  py-3 px-2">
                                            <h5 class="card-title text-capitalize">Đại gia Gatsby(TB2020)</h5>
                                            <div class="card-text d-flex justify-content-between">
                                                <p class="text-dark font-weight-bold">$24.99</p>
