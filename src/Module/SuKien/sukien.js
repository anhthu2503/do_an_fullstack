                ...
                <div className="container">
                    ...
                    <div className="row next">
                        ...
                        <div className="col-lg-2 pt-4 pt-lg-0 order-2 order-lg-1 content">
                            <a href="nd-su-kien-1.html" ><img className="img-sk" src="img/7041.jpg" alt="Ngày sách Việt Nam lần thứ 8 hứa hẹn sẽ có nhiều hoạt động sôi nổi" /></a>
                        </div>
                                ...
                                <div className="box_content">
                                    <div className="w3-row" id="box_list">
                                        ...
                                        <div className="w3-col l3 m3 s3 logo img-doc-nhieu">
                                            <img src="img/6991.jpg" alt="9 lợi ích của sách nói và làm sao để tối ưu hóa chúng?" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="row next">
                        ...
                        <div className="col-lg-2 pt-4 pt-lg-0 order-2 order-lg-1 content">
                            <a href="nd-su-kien-2.html"><img src="img/7063.jpg" alt="Nhà văn Nguyễn Nhật Ánh “bật mí” về một bộ phim mới sẽ được chuyển thể từ tác phẩm của ông"/></a>
                        </div>
                            ...
                            <div className="most_read">
                                <div className="box_content">
                                    <div className="w3-row" id="box_list">
                                        ...
                                        <div className="w3-col l3 m3 s3 logo img-doc-nhieu">
                                            <img src="img/467.jpg" alt="35 cuốn sách hay nên đọc trong đời" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="row next">
                        ...
                        <div className="col-lg-2 pt-4 pt-lg-0 order-2 order-lg-1 content">
                            <a href="nd-su-kien-3.html"><img src="img/7001.jpg" alt="Dự án tặng 1000 audio book miễn phí đến độc giả"/></a>
                        </div>
                    ...
                    <div className="row next">
                        ...
                        <div className="col-lg-2 pt-4 pt-lg-0 order-2 order-lg-1 content">
                            <a href="nd-su-kien-4.html"><img src="img/6797.jpg" alt="10 tác phẩm văn học tiêu biểu của Việt Nam được tái bản"/></a>
                        </div>
